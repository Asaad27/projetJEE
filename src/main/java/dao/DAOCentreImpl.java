...
public class DAOCentreImpl implements DAOCentre{
    ...
    private static final String SQL_INSERT = "INSERT INTO centre (email_centre,nom_centre,id_ville,id_admin,telephone_centre,adresse_centre,password_centre) "
            + "VALUES (?, ?, ?,?,?,?,?)";
    private static final String SQL_UPDATE_BYID = "UPDATE centre set email_centre=?, nom_centre=?, id_ville=?, id_admin=?, telephone_centre=?, adresse_centre=?, password_centre=? where id_centre=?";
    ...
    public static Centre map( ResultSet resultSet ) throws SQLException {
        ...
        centre.setId_admin( resultSet.getInt( "id_admin" ) );
    ...
    public void modifier(Centre centre) throws IllegalArgumentException, DAOException {
        ...
        try{
            ...
            preparedStatement.setInt(4,centre.getId_admin());
    ...
    public List<Centre> lister() {
        ...
        try {
            ...
            while(result.next()) {
                ...
                centre.setId_admin(result.getInt("id_admin"));
